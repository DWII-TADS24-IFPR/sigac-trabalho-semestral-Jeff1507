...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-[#D0BCFF] text-sm font-medium leading-5 text-zinc-100 focus:outline-none focus:border-purple-500 transition duration-150 ease-in-out'
